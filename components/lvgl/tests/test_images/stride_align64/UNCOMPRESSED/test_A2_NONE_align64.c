...
#ifndef LV_ATTRIBUTE_TEST_A2_NONE_ALIGN64
#define LV_ATTRIBUTE_TEST_A2_NONE_ALIGN64
#endif

static const
LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_TEST_A2_NONE_ALIGN64
...
const lv_image_dsc_t test_A2_NONE_align64 = {
  ...
  .header.h = 60,
  .header.stride = 32,
  .data_size = sizeof(test_A2_NONE_align64_map),
